...
export default function WinPopup({tries, dailyJoker}: {tries: number, dailyJoker: Joker}) {
    ...
    <div className="flex absolute w-[100%] h-[100%] z-2 bg-[var(--background-win)] justify-center items-center">
        <div 
        className="w-[72%] h-[67%] bg-[var(--balatro-lavender)] p-[0.25rem]"
        style={baseCorner}
        >
        <div className="flex flex-col items-center w-[100%] h-[100%] bg-[var(--body-main)]" style={baseCorner}>
